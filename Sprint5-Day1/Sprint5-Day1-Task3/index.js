...
document.querySelector('.top-content  h4').textContent =
  siteContent['top-content']['left-h4'];
document.querySelector('.top-content  p').textContent =
...
document.querySelector('.bottom-content h4').textContent =
  siteContent['bottom-content']['left-h4'];
document.querySelector('.bottom-content p').textContent =
